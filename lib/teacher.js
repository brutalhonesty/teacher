 ...
 * @param {Array} Params.custom
 * @param {Function} Callback.
 * @api public
 */
Teacher.prototype.check = function(params, fn) {
  var ignored = this.ignore();

  this.api.get(params.text, 'checkDocument', this.language(), function(err, data) {
    ...
    var errors = data.error.filter(function(obj) {
      return !(~ignored.indexOf(obj.type)) && !(params.custom ? params.custom.indexOf(obj.string.toLowerCase()) !== -1 : false);
    });
